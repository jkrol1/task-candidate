...
@pytest.mark.parametrize(
    "algorithm_input, expected_algorithm_output, target_sum",
    SUBTRACTION_STRATEGY_ALGORITHM_INPUT_OUTPUT_TARGET_SUM,
)
def test_subtraction_strategy(
    algorithm_input: AlgorithmInput,
    expected_algorithm_output: AlgorithmOutput,
    target_sum: int,
) -> None:
    strategy = SubtractionStrategy()
    algorithm_output = strategy.get_pairs_from_algorithm_input_and_target_sum(
        algorithm_input, target_sum
    )
